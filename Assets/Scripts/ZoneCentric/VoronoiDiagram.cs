...
public class VoronoiDiagram : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Controller.GetHairTriggerDown())
        {
            ...
            Debug.Log("Point is ===============> " + pos.x + " " + pos.y + " " + pos.z);
        }
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(40, 40, Screen.width, Screen.height), _trackedObj.transform.position.x + " " + _trackedObj.transform.position.y + " " + _trackedObj.transform.position.z);
    }
